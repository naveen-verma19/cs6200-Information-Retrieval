...
def process_url_and_store(score_tuple, domain_last_request):
    ...
    text_relevant_count = get_relevance_count(txt)
    if text_relevant_count < 2:
    ...
    print("processing outgoing links", can_url)
    ...
    text_relevant_score = text_relevant_count / keywords_length  # 0-1
    ...
    for linkObj in outgoing_links:
        ...
        if canolink in fib_Hash:
            ...
            newscore = oldscore_positive + positive_score_this_page * text_relevant_score
            ...
            olink_rank_score = (10 - rank / 100000)
            olink_wave_num = wave_num_this_page + 1
            olink_referScore = positive_score_this_page * text_relevant_score
